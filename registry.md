...
| 029 | ディレクトリ構成・機能役割分担・処理フロー図 | 2026-03-22 | ディレクトリ構成ごとの機能役割分担と、ユーザーリクエストの処理フローを図示・整理。 |
| 030 | 設定オプション過多問題の分析 | 2026-03-22 | 100個以上の環境変数を棚卸し。5検索戦略×6フラグ×多数閾値の組み合わせ爆発が主要問題。 |
| 031 | フロントエンド3ディレクトリを frontend/ に統合 | 2026-03-22 | admin/, dashboard-frontend/, widget/ を frontend/ 配下に移動。15ファイルのパス参照修正。 |
| 032 | セッション永続化 & 選択UI の設計・タスク起票 | 2026-03-22 | 会話セッションの永続化とChatGPT/Geminiライクなセッション選択UIの設計を行い、タスク015を起票。 |
