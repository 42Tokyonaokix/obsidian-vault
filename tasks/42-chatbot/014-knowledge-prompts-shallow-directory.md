...
- [x] knowledge/ ディレクトリ移動 + seed_knowledge.py + Docker修正
- [x] 単一エージェントプロンプトMD移動 + loader.py PROMPTS_DIR修正
- [x] マルチエージェントプロンプトMD移動 + __init__.py PROMPTS_DIR修正
- [x] 全体動作確認 + 旧パス残存チェック

実装PR: https://github.com/Digitalgrid-dev/42-chatbot/pull/38
