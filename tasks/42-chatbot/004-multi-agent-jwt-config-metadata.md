...
- [x] T-3: execute_task_node に config: RunnableConfig を追加し agent.ainvoke に転送
...
- [x] T-4: Data Agent ツール全7件を config.metadata 方式に変更
